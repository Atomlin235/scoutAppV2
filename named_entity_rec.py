...
def title_extract_tech_skills(dataframe):
...
def desc_extract_tech_skills(dataframe):
    #Use Spacy load() to import a model
    ...
    desc_ruler = nlp.add_pipe('entity_ruler', before='ner')
    desc_ruler.add_patterns(tech_skills)
...
def title_extract_soft_skills(dataframe):
    #Use Spacy load() to import a model
...
def desc_extract_soft_skills(dataframe):
    #Use Spacy load() to import a model
    ...
    desc_soft_ruler = nlp.add_pipe('entity_ruler', before='ner')
    desc_soft_ruler.add_patterns(soft_skills)
